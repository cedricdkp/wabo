...
<head>
    ...
    <style>
        .bg-benin {
            background-image: url('../asset/ChatGPT Image 31 mars 2025, 15_31_20.png');
...
<section id="objectif" class="container mx-auto px-6 py-12 flex flex-col md:flex-row items-center justify-between">
    <div class="w-full md:w-1/2 flex justify-center">
        <img src="../asset/ChatGPT Image 31 mars 2025, 16_52_17.png" alt="Paysage culturel du Bénin" class="w-full md:w-10/12 rounded-lg shadow-xl transform hover:scale-105 transition-all duration-300" loading="lazy">
    </div>
...
<section id="destinations" class="container mx-auto px-6 py-12">
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        <a href="{{ route('destination.show', 'ouidah') }}" class="relative group" aria-label="Visiter Ouidah">
            <img src="../asset/R.jpeg" alt="Temple des Pythons à Ouidah" class="w-full h-48 object-cover rounded-lg transition duration-300 group-hover:scale-105" loading="lazy">
        ...
        <a href="{{ route('destination.show', 'pendjari') }}" class="relative group" aria-label="Visiter le Parc de la Pendjari">
            <img src="../asset/pendjari-national-park.jpg" alt="Faune du Parc de la Pendjari" class="w-full h-48 object-cover rounded-lg transition duration-300 group-hover:scale-105" loading="lazy">
            <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center text-white text-lg font-semibold opacity-0 group-hover:opacity-100 transition duration-300">
                Parc de la Pendjari
            </div>
        </a>
        <a href="{{ route('destination.show', 'ganvie') }}" class="relative group col-span-2 md:col-span-1 md:row-span-2" aria-label="Visiter Ganvié">
            <img src="../asset/R (1).jpeg" alt="Village lacustre de Ganvié" class="w-full h-full object-cover rounded-lg transition duration-300 group-hover:scale-105" loading="lazy">
...
relative group" aria-label="Visiter Porto-Novo">
            <img src="../asset/R (2).jpeg" alt="Musée ethnographique de Porto-Novo" class="w-full h-48 object-cover rounded-lg transition duration-300 group-hover:scale-105" loading="lazy">
            <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center text-white text-lg font-semibold opacity-0 group-hover:opacity-100 transition duration-300">
                Porto-Novo
            </div>
        </a>
        <a href="{{ route('destination.show', 'kota') }}" class="relative group" aria-label="Visiter les Chutes de Kota">
            <img src="../asset/large-waterfall.jpg" alt="Chutes de Kota à Natitingou" class="w-full h-48 object-cover rounded-lg transition duration-300 group-hover:scale-105" loading="lazy">
            <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center text-white text-lg font-semibold opacity-0 group-hover:opacity-100 transition duration-300">
                Chutes de Kota - Natitingou
            </div>
        </a>
        <a href="{{ route('destination.show', 'abomey') }}" class="relative group" aria-label="Visiter Abomey">
            <img src="../asset/private-palace-of-king.jpg" alt="Palais royaux d'Abomey" class="w-full h-48 object-cover rounded-lg transition duration-300 group-hover:scale-105" loading="lazy">
            <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center text-white text-lg font-semibold opacity-0 group-hover:opacity-100 transition duration-300">
                Abomey
            </div>
        </a>
        <a href="{{ route('destination.show', 'grand-popo') }}" class="relative group" aria-label="Visiter Grand-Popo">
            <img src="../asset/grand-popo.png" alt="Plage de Grand-Popo" class="w-full h-48 object-cover rounded-lg transition duration-300 group-hover:scale-105" loading="lazy">
            <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center text-white text-lg font-semibold opacity-0 group-hover:opacity-100 transition duration-300">
                Grand-Popo
            </div>
        </a>
...
<section id="evenements-culturels" class="container mx-auto px-6 py-12">
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        <a href="{{ route('event.show', 'vodun-days') }}" class="relative group" aria-label="Participer aux VoDun Days">
            <img src="../asset/OIP (2).jpeg" alt="Célébration des VoDun Days" class="w-full h-48 object-cover rounded-lg shadow-md transition duration-300 group-hover:scale-105" loading="lazy">
        ...
        <a href="{{ route('event.show', 'festival-musique') }}" class="relative group" aria-label="Visiter le Festival de Musique">
            <img src="../asset/OIP (3).jpeg" alt="Scène du Festival de Musique" class="w-full h-48 object-cover rounded-lg shadow-md transition duration-300 group-hover:scale-105" loading="lazy">
            <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center text-white text-xl font-semibold opacity-0 group-hover:opacity-100 transition duration-300">
                Festival de Musique
            </div>
        </a>
        <a href="{{ route('event.show', 'atelier-traditionnel') }}" class="relative group" aria-label="Participer à l'Atelier Traditionnel">
            <img src="../asset/IMG-20240412-WA0145.jpg" alt="Atelier d'artisanat traditionnel" class="w-full h-48 object-cover rounded-lg shadow-md transition duration-300 group-hover:scale-105" loading="lazy">
            <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center text-white text-xl font-semibold opacity-0 group-hover:opacity-100 transition duration-300">
        ...
        <a href="{{ route('event.show', 'festival-masques') }}" class="relative group" aria-label="Participer au Festival des Masques">
            <img src="../asset/4.jpeg" alt="Festival des Masques à Porto-Novo" class="w-full h-48 object-cover rounded-lg shadow-md transition duration-300 group-hover:scale-105" loading="lazy">
            <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center text-white text-xl font-semibold opacity-0 group-hover:opacity-100 transition duration-300">
        ...
        <a href="{{ route('event.show', 'fete-igname') }}" class="relative group" aria-label="Participer à la Fête de l'Igname">
            <img src="../asset/savalou.jpg" alt="Fête de l'Igname à Savalou" class="w-full h-48 object-cover rounded-lg shadow-md transition duration-300 group-hover:scale-105" loading="lazy">
            <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center text-white text-xl font-semibold opacity-0 group-hover:opacity-100 transition duration-300">
        ...
        <a href="{{ route('event.show', 'fete-independance') }}" class="relative group" aria-label="Célébrer la Fête de l'Indépendance">
            <img src="../asset/OIP.jpeg" alt="Fête de l'Indépendance du Bénin" class="w-full h-48 object-cover rounded-lg shadow-md transition duration-300 group-hover:scale-105" loading="lazy">
            <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center text-white text-xl font-semibold opacity-0 group-hover:opacity-100 transition duration-300">
...
<section id="forfaits" class="container mx-auto px-6 py-12">
    ...
    <div class="grid md:grid-cols-3 gap-6">
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            <img src="../asset/ChatGPT Image 1 avr. 2025, 10_21_37.png" alt="Circuit dans la nature sauvage du Bénin" class="w-full h-48 object-cover" loading="lazy">
            <div class="p-6">
        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            <img src="../asset/OIP (1).jpeg" alt="Visite culturelle au Bénin" class="w-full h-48 object-cover" loading="lazy">
            <div class="p-6">
        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            <img src="../asset/grand-popo.png" alt="Plage relaxante à Grand-Popo" class="w-full h-48 object-cover" loading="lazy">
            <div class="p-6">
...
<section id="agences" class="container mx-auto px-6 py-12">
    ...
    <div class="grid md:grid-cols-3 gap-8">
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            <img src="../asset/13.jpg" alt="Circuit avec Voyage Bénin Tour" class="w-full h-48 object-cover" loading="lazy">
        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            <img src="../asset/9.jpeg" alt="Voyage avec Bénin Découverte" class="w-full h-48 object-cover" loading="lazy">
            <div class="p-6 text-center">
        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            <img src="../asset/10.jpeg" alt="Exploration avec ExploBénin" class="w-full h-48 object-cover" loading="lazy">
            <div class="p-6 text-center">
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
        <div class="bg-white shadow-lg rounded-lg p-6">
            <div class="flex items-center mb-4">
                <img src="../asset/11.jpeg" alt="Photo de Jean Dupont" class="w-12 h-12 rounded-full mr-4" loading="lazy">
                <div>
        ...
        <div class="bg-white shadow-lg rounded-lg p-6">
            <div class="flex items-center mb-4">
                <img src="../asset/grown-up-3051074_1280.jpg" alt="Photo de Marie Lemoine" class="w-12 h-12 rounded-full mr-4" loading="lazy">
                <div>
        ...
        <div class="bg-white shadow-lg rounded-lg p-6">
            <div class="flex items-center mb-4">
                <img src="../asset/12.jpeg" alt="Photo de Sophie Martin" class="w-12 h-12 rounded-full mr-4" loading="lazy">
                <div>
        ...
        <div class="bg-white shadow-lg rounded-lg p-6">
            <div class="flex items-center mb-4">
                <img src="../asset/1517813703981.jpeg" alt="Photo de Lucie Dufresne" class="w-12 h-12 rounded-full mr-4" loading="lazy">
                <div>
